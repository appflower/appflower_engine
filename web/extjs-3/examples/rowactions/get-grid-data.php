...
$data = array(
	...
	array("company"=>'Alcoa Inc',                                   "hide2"=>false,"action1"=>"icon-undo","action2"=>"icon-rename","action3"=>"icon-key","qtip1"=>"Click to Undo","qtip2"=>"Click to Rename","qtip3"=>"Tooltip 3", "lastChange"=>'9/1 12:00am', "industry"=>'Manufacturing'),
	array("company"=>'Altria Group Inc',                            "hide2"=>true,"action1"=>"icon-coins","action2"=>"icon-clock","action3"=>"icon-key","qtip1"=>"Click to Save","qtip2"=>"Tooltip 2","qtip3"=>"Tooltip 3", "lastChange"=>'10/1 12:00am', "industry"=>'Manufacturing'),
	array("company"=>'American Express Company',                    "hide2"=>false,"action1"=>"icon-save-table","action2"=>"icon-add-col","action3"=>"icon-key","qtip1"=>"Tooltip 1","qtip2"=>"Tooltip 2","qtip3"=>"Tooltip 3", "lastChange"=>'9/1 10:00am', "industry"=>'Finance'),
	...
	array("company"=>'Citigroup, Inc.',                             "hide2"=>false,"action1"=>"icon-disk","action2"=>"icon-cross","action3"=>"icon-key","qtip1"=>"Tooltip 1","qtip2"=>"Tooltip 2","qtip3"=>"Tooltip 3", "lastChange"=>'9/1 12:00am', "industry"=>'Finance'),
	...
	array("company"=>'Pfizer Inc',                                  "hide2"=>false,"action1"=>"icon-disk","action2"=>"icon-cross","action3"=>"icon-key","qtip1"=>"Tooltip 1","qtip2"=>"Tooltip 2","qtip3"=>"Tooltip 3", "lastChange"=>'9/1 12:00am', 'Services', "industry"=>'Medical'),
