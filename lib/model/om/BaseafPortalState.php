...
/**
 * Base class that represents a row from the 'af_portal_state' table.
 *
 * 
 *
 * @package    propel.generator.plugins.appFlowerPlugin.lib.model.om
 */
abstract class BaseafPortalState extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'afPortalStatePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        afPortalStatePeer
	 */
	...
	/**
	 * The value for the id_xml field.
	 * @var        string
	 */
	protected $id_xml;
	...
	/**
	 * Set the value of [id_xml] column.
	 * 
	 * @param      string $v new value
	 * @return     afPortalState The current object (for fluent API support)
	 */
	public function setIdXml($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->id_xml !== $v) {
			$this->id_xml = $v;
			$this->modifiedColumns[] = afPortalStatePeer::ID_XML;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = afPortalStatePeer::USER_ID;
		}
	...
	public function setLayoutType($v)
	{
		...
		if ($this->layout_type !== $v) {
			$this->layout_type = $v;
			$this->modifiedColumns[] = afPortalStatePeer::LAYOUT_TYPE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_xml = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->user_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->layout_type = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = afPortalStatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseafPortalState:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseafPortalState:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				afPortalStatePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = afPortalStatePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = afPortalStatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setIdXml($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(afPortalStatePeer::ID)) $criteria->add(afPortalStatePeer::ID, $this->id);
		if ($this->isColumnModified(afPortalStatePeer::ID_XML)) $criteria->add(afPortalStatePeer::ID_XML, $this->id_xml);
		if ($this->isColumnModified(afPortalStatePeer::USER_ID)) $criteria->add(afPortalStatePeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(afPortalStatePeer::LAYOUT_TYPE)) $criteria->add(afPortalStatePeer::LAYOUT_TYPE, $this->layout_type);
		if ($this->isColumnModified(afPortalStatePeer::CONTENT)) $criteria->add(afPortalStatePeer::CONTENT, $this->content);
		if ($this->isColumnModified(afPortalStatePeer::CREATED_AT)) $criteria->add(afPortalStatePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(afPortalStatePeer::UPDATED_AT)) $criteria->add(afPortalStatePeer::UPDATED_AT, $this->updated_at);
	...
	{
		$criteria = new Criteria(afPortalStatePeer::DATABASE_NAME);
		$criteria->add(afPortalStatePeer::ID, $this->id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     afPortalState Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     afPortalStatePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new afPortalStatePeer();
		}
		return self::$peer;
	}
