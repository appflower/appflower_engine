...
/**
 * Base class that represents a row from the 'af_validator_cache' table.
 *
 * 
 *
 * @package    propel.generator.plugins.appFlowerPlugin.lib.model.om
 */
abstract class BaseafValidatorCache extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'afValidatorCachePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        afValidatorCachePeer
	 */
	...
	public function setSignature($v)
	{
		...
		if ($this->signature !== $v) {
			$this->signature = $v;
			$this->modifiedColumns[] = afValidatorCachePeer::SIGNATURE;
		}
	...
	public function setPath($v)
	{
		...
		if ($this->path !== $v) {
			$this->path = $v;
			$this->modifiedColumns[] = afValidatorCachePeer::PATH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->signature = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = afValidatorCachePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseafValidatorCache:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseafValidatorCache:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				afValidatorCachePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = afValidatorCachePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = afValidatorCachePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setSignature($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(afValidatorCachePeer::ID)) $criteria->add(afValidatorCachePeer::ID, $this->id);
		if ($this->isColumnModified(afValidatorCachePeer::SIGNATURE)) $criteria->add(afValidatorCachePeer::SIGNATURE, $this->signature);
		if ($this->isColumnModified(afValidatorCachePeer::PATH)) $criteria->add(afValidatorCachePeer::PATH, $this->path);
		if ($this->isColumnModified(afValidatorCachePeer::CREATED_AT)) $criteria->add(afValidatorCachePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(afValidatorCachePeer::UPDATED_AT)) $criteria->add(afValidatorCachePeer::UPDATED_AT, $this->updated_at);
	...
	{
		$criteria = new Criteria(afValidatorCachePeer::DATABASE_NAME);
		$criteria->add(afValidatorCachePeer::ID, $this->id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     afValidatorCache Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     afValidatorCachePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new afValidatorCachePeer();
		}
		return self::$peer;
	}
