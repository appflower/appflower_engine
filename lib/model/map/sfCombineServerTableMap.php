...
/**
 * This class defines the structure of the 'sf_combine_server' table.
 *
 *
 *
...
class sfCombineServerTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'plugins.appFlowerPlugin.lib.model.map.sfCombineServerTableMap';
