...
/**
 * This class defines the structure of the 'af_widget_setting' table.
 *
 *
 *
...
class afWidgetSettingTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'plugins.appFlowerPlugin.lib.model.map.afWidgetSettingTableMap';
