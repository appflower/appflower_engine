...
/**
 * This class defines the structure of the 'af_save_filter' table.
 *
 *
 *
...
class afSaveFilterTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'plugins.appFlowerPlugin.lib.model.map.afSaveFilterTableMap';
