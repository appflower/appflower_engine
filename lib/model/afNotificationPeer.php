...
class afNotificationPeer extends BaseafNotificationPeer
{
	public static function getNotifications(){		
		...
		if(count($objs) > Notification::WHEN_EXCEEDS){
			...
			$msg = "You have ".(count($objs)-Notification::MAX_SHOW_NOTIFICATIONS)." more notifications. please <a href='/appFlower/listNotifications' style='color:#0000ff'>click here</a> to view them all.";
