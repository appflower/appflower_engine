 ...
 */
class ImmExtjsFieldItemSelectorAutoSuggest extends ImmExtjsField
{
	...
	{		
		...
		$this->immExtjs->setAddons(array ('js' => array($this->immExtjs->getExamplesDir().'multiselect/Ext.ux.plugins.ItemSelectorAutoSuggest.js') ));
