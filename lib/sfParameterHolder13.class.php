...
/**
 * sfParameterHolder class from symfony 1.3
 * It supports call like:
 * $parameterHolder->get('edit[0]');
 * Such construction is used in AF internals - this should be refactored and
 * after that we can delete sfParameterHolder13 and sfToolkit13 classes.
 */
 ...
 */
class sfParameterHolder13 implements Serializable
{
  ...
  public function & get($name, $default = null)
  {
    ...
    {
      $value = sfToolkit13::getArrayValueForPath($this->parameters, $name, $default);
    }
