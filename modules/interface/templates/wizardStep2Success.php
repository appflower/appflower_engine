...
$form=new afExtjsForm(array('action'=>'/interface/test','title'=>'Form','portal'=>true,'tools'=>$tools,'classic'=>true));
...
new afExtjsLinkButton($layout,array('label'=>'Previous (step1)','url'=>'https://192.168.198.129/interface/wizardStep1','disabled'=>true));

new afExtjsSubmitButton($layout,array('label'=>'Previous (step1&submit)','action'=>'/interface/wizardStep1','method'=>'get'),$form);
